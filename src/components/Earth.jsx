          ...
          <div className="w-[90vw] sm:w-[800px] m-10 -mt-5 flex flex-col justify-center items-center">
            ...
            >
              ...
              <p style={poppins.style} className="text-[16px] text-center m-0">
                I'm Abdurrahman Hassan, a versatile Fullstack Developer skilled
                in React, Next.js, MERN Stack, and more. I'm passionate about
                creating user-centric web solutions that simplify tasks and
                improve lives. In my free time, I love diving into programming
                and exploring new tech. Let's collaborate on your next project!
              </p>
              <a
